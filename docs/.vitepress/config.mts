    ...
    sidebar: {
      "/docs": [
        ...
        },
        {
          ...
          collapsed: false,
          items: [
            {text: "Structure", link: "/docs/features/structure"},
            {text: "Shape", link: "/docs/features/shape"},
            {text: "Color", link: "/docs/features/color"},
            {text: "Event", link: "/docs/features/event"},
            {text: "Image", link: "/docs/features/image"},
            {text: "Typography", link: "/docs/features/typography"},
            {text: "Helper", link: "/docs/features/helper"},
          ],
        },
        {
          text: "API Reference",
